...
description: Scattered into a rewritten past, the heroes gather the legends of a mythic age as the living moonblades begin to remember and the war against Netheril gathers.
sidebar:
  order: 6
type: event
kind: history
...
fields:
  ...
  region: Camelot, Avalon, the road to Netheril
  status: Complete
...
**Arc VI — Time of Troubles** is the sixth arc of [Temple Holdings LLC](/lore/temple-holdings-llc/), set in a past that has been *edited*. Scattered through time after Starfall, the heroes reunite in a mythic age of falling empires and reborn gods, and find that they can change it. They gather the legends of Camelot and Avalon and the elven founders against the rising power of [Netheril](/places/netheril/); the living moonblades, almost reunited, recover their memories of the age the Oblivia erased; and Zebulon the Meek leads the party to the Chronicle under a volcano northeast of Enkidu. The arc opens with an epigraph:
...
The stone is black, and cut from the Moon. The Company's own researchers would later hypothesise a Phase-V moonstone — which they called **Perfect Dark** — as the only thing that could let the Anachron warp time. The party had already made one. In the deep past, after Roland shot St. Cloud, they took his [Tudyx Cube](/items/the-tudyx-cube/), found it empty, placed a perfect moonstone inside and closed the lid. Then they opened the sealed box they had stolen from St. Cloud's quarters on the [Arielle](/items/the-arielle/), and a Perfect Dark moonstone came out, after a presumed 65 million years inside it. <small>(Oral Histories: The Inevitables, 2021-12-03)</small> Whether Maab's gem is that stone is not recorded.
...
> I remember these times much better now… much of this age was erased from history, which for you is written record but for me, is empty spaces spoiling my persistent memory. But now that I've seen myself as I was in this time — with Eldamir — I remember what it was like. Elistrae came to us in the body of a human girl, and the elders did not know what to do… The elvish god had fused to a mortal soul in order to be born and spread her grace. They had no choice in the matter.\
> \
...
<small>— Zebulon the Meek, Arc VI Part IX. Sic on "and I five blades" and "an swirling."</small>

The site is a volcanic outcropping northeast of Enkidu under a cloud formation that does not move naturally. Its hardened magma resists intrusion — a Disintegrate spell removes no more than 125 cubic feet at a time — and long bore holes surround the formation from earlier attempts, with Netherese researchers and guards still working one opening at the top of a long slope. "The Chronicle is said to be powered by the heat of an ancient volcano below the ground, but at one time, this was a towering and glittering ivory fortess. The Netherese destroyed it trying to get to the Chronicle. It must have erupted this magma to seal itself off and kill the attackers." <small>(Sic on "fortess." Arc VI Part IX, "Rock Flow.")</small>

Inside, at the **Seat of Cypher**, the terminal answers a user with a lockdown, and a root crash restore — Eloise can enter her own authorization — fails in the kernel:

> "AY-ROR (error) TERMINAL LOCKDOWN COMPLETE. NO ACCESS PERMITTED TO THE CORE."

> "FATAL AY-ROR IN KERNEL. UNABLE TO RESTORE. PLEASE CONTACT YOUR SYSTEM ADMINISTRATOR."

Ayror is separately the name of the demon god of [Motherstone](/history/arc-ii-motherstone/), "once a great god of light and knowledge," who "forgot himself." The record does not state a connection between the god and the terminal's fault code. <small>(Arc VI Part IX, "The Seat of Cypher.")</small>

The machine under the volcano is the [Anachron](/items/the-anachron/), the drive of the party's airship the Arielle. The [Lexicon](/items/the-lexicon/) had been built into the Arielle, and Lex transferred himself to the ship at the Second Battle of Motherstone <small>(Oral Histories: Temporal Holdings, 2019-05-05; 2019-05-28)</small>. The machine was left behind in the deep past when the Arielle crashed, and held since as god and instrument by thousands of cultures, the orcish artificers of Zebulon's people among the last of them. The party did not know this when they reached it.

The site is also called **the Archives**. The Netherese stole and ruined the Chronicle, "the record of his people’s knowledge", and obliviated the orcs' historians, and never got into the machine. <small>(Oral Histories: Temporal Holdings, 2020-11-22)</small>
