...
fields:
  ...
  ggmtitle: Scholar-explorer
  dobDisplay: Unknown
  birthplace: Unknown
  children: Fhastine Mageblood
  residence: A camp inside the Snowy Mountain machine, where she died
  gender: Female
  age: Died roughly a century before the chronicle
  eyes: Blind in the left eye, from reading the cursed tome
  hair: Unknown
  skin: Unknown
  height: Unknown
  weight: Unknown
sources:
- Desktop/infantaverse-wiki/src/content/docs/characters/mara-mageblood.mdx
...
- worldanvil/sources/infantaverse/Notes__TONI CHEAT SHEET.txt
...
Mara Mageblood was an elf scholar-explorer who chased the forgotten history of [Motherstone](/places/motherstone/) a century before the heroes. She read a cursed Orcish tome, *The Betrayal of Motherstone*, went blind in her left eye, and died in a makeshift camp deep inside the Snowy Mountain machine, leaving her journal hidden with her wedding dress for her daughter **Fhastine** to find. [Kara](/people/kara/) recovered the journal a hundred years later, and the party has carried it since.

## What survives of her

No description of Mara is recorded; nobody living ever saw her. What survives is an abandoned camp in the Great Pipes beneath Snowy Mountain — "the grave of an elf of some magical prowess," as the healer who stumbled on it put it — a wedding dress, and a journal. Kara and [Brother Magnus](/people/brother-magnus/) find the camp on the climb up the Great Pipes at the opening of [Arc II](/history/arc-ii-motherstone/), a hundred years too late to help.
...
Publicly she was an explorer with a scholar's obsession and a daughter. She did not send the journal home. She hid it with her wedding dress for **Fhastine** to find when she was grown; nobody who has since tried to read it has succeeded.

## The lullaby

The lullaby is a nursery song Mara's own mother could never sing all the way through without losing herself. Copied into the journal, it encodes the secret of the Forgetting in verses that read as harmless until the last line, and it contains the survival instruction that saves the heroes' lives in the guardian's chamber beneath Motherstone: *hold your breath and close your eyes*.
...
<small>— Mara Mageblood, final letter, found in the Snowy Mountain camp</small>

## Right now

Her remains are still in the mountain. Her journal is in the party's hands.
...
- **Fhastine Mageblood** — her daughter, the half-elf apothecary of *The Dram* in Harloch, who kept a journal she could not read and a riddle she could not solve. Alive.
- **Kara** — found her camp, her letter and her journal a century after her death, and finished the job. The reader Mara wrote for.
- **Her mother** — unnamed in the record; the source of the lullaby, and the first person it hurt.
- **Calix the Betrayer** — never met him. Named him anyway.
