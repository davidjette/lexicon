...
description: 'The Infernal Machine that erases knowledge from the memory of everyone who ever lived: the engine of the Forgetting, and the weapon that ended the chronicle.'
type: item
kind: items
tags:
- The Obliviator
...
fields:
  ...
  rarity: Unknown
  condition: Knocked out of stasis; unstable
  status: Active above Motherstone
sources:
- Desktop/infantaverse-wiki/src/content/docs/items/the-obliviator.mdx
...
The [Sword Coast Trading Company](/organizations/sword-coast-trading-company/) could never control it, so it did the next thing: it learned to read the machine's leylines "to transmit magic energy and information across great distances and even between the planes," and "designed features into their consumer devices which exploited this power." Every device the Company manufactures "will respond to remote control and broadcast any message the Company desired, not into sound, but into the minds of nearby sentient beings."

## Unstable

The gnome **Flex Gimble**'s tampering knocked it out of stasis, and the Lexicon's warning is not a small one:
...
At Starfall the session record names the apparatus St. Cloud sabotages as the "mammon-obliviator-anachron" — the [Mammon Machine](/items/the-mammon-machine/), the Obliviator and the Anachron joined into one device. The stated aims of the sabotage are "to awaken and alert Cthulhu that his children are here" and "to veer toward Ydrissl." <small>(Arc V, [Starfall](/history/arc-v-starfall/), Parts II through IV.)</small> The Company's R&D had anticipated the bridge: "R&D believes bridging the Obliviator and the Mammon Machine will enable the Oblivator to be like a broadcast system for thoughts." <small>(Sic on "Oblivator." Arc IV, SCTC Archives.)</small>

## Described by someone who never learned its name

In the Netherese era [Zebulon the Meek](/people/zebulon/) relates, from the salvaged notes of his master Curtis Washington, that among the devices held by the orcish artificers at Yog "was a great orb which could only operate on the power of a planar rift or some other great battery of energy." Washington "believed the device was more not a bomb, but rather a conduit for the convection of mental and magical energies," and observed that when it was fired "it generated a force field that caused not only his own mind but writing and other data to become incomprehensible." His theory:

> His theory is that at full power, the device was capable of creating a, “Obliviation” field that could erase information from existence, and shield knowledge of whatever was inside the force field from detection or even memory outside the field.

<small>— Zebulon, Arc VI Part IX, "The Chronicle." Sic on "more not a bomb" and "creating a, “Obliviation” field." Washington's notes never name the device. See [The Chronicle](/items/the-chronicle/).</small>
...
The Obliviator is also how the story stops. The heroes beat [Cthulhu](/lore/the-leviathan/)'s head to nothing and **touch it with an Obliviator**, triggering a shockwave of negation magic — the End of the Infanta — that unwrites the god, the war, and the heroes with them. A final Wish may choose what the world keeps, "with the consequence that they themselves will be forgotten in all but the vaguest terms." The Oblivia is the hole this act left behind.

Among what that final Obliviation removed from memory was the Infantaverse quest itself and, with it, the premise and existence of time travel using the Anachron. The Lexicon — housed in the Anachron since the Second Battle of Motherstone — lost knowledge of its own latent power over time in the same act and did not recover it for millennia. The Obliviator had been used to trim the Lexicon's mind when Brightmantle built it; its last use in the chronicle trimmed the same mind again. <small>(The Lexicon "forgets for millennia due to the Obliviation of the Infantaverse quest from memory by Cypher in the finale with Cthulhu/along with the premise and existence of time travel using the Anachron." See [The Anachron](/items/the-anachron/) and [the Oblivia](/lore/the-oblivia/).)</small>
