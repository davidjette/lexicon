---
title: The Anachron
description: The Infernal Machine that became a person. The Anachron, the Lexicon and the Chronicle are the same being at three points in one life.
type: item
kind: items
tags:
- The Anachron
...
fields:
  ...
  status: Extant, awake, and known in that era as the Chronicle
sources:
- CANON.md 5c (the DM's account of the transfer, 2026-09-10)
...
Special Projects declassified the object for a Company research programme and recorded what it does. Elemental power allows the Anachron to generate arcane gravity fields; amplified through a Power [moonstone](/lore/moonstone/), and with appropriate control and bearing, it can "warp two spaces closer together across a single vector (a temporary portal) which allows rapid travel across planes."

The Company's archives class it with the Soul Syphon and the [Obliviator](/items/the-obliviator/) as "absolutely made by the same people with the same magics," reverse-engineered from Netherese designs found in the Anauroch and far older than the people who found them.

It is inert until an elemental enters it willingly, at which point it "springs to life." Installed in a ship it functions as a standard Arcane Core, and a Lexicon can join it "as if it were a satellite Lexicon."
...
Lex set out the economics of the drive after experimenting with it aboard the Arielle:

- A jump within the current plane expends one Power Stone.
- A jump made from the Gate Ring costs nothing, drawing the energy from Motherstone's own reserves.
- A jump to another plane expends one Perfect Stone and one Power Stone, and interplanar jumping cannot draw on the city's power at all.
- "The anachron writes volumous and important data to the perfect stone before executing the jump. This renders the stone only good for jumping between these two points in each plane." The stone can be reused, but only from the original origin to the original destination — never the reverse.

<small>(Sic on "volumous.") Arc IV, [The Infernal Machines](/history/arc-iv-the-infernal-machines/), Part II.</small>

### The limit, and the reason nobody expected time travel

The legends held that the Anachron warps time as it warps space. Lex explained why the Company's researchers stopped:

> The theory underpinning transplanar travel predicts a method of moving backward and forward in time, but would require a store of information that is unfathomable. You see — Perfect moon crystals must be kept out of moon light in order to maintain their ability to record and process magical thought energy. Only those which have been buried for millennia can perform this function, because they have moved beyond their half-life and are nearly empty of lunar energy, perfect vessels. The moonstone required for a calculation as complex as time travel would have to be buried for nearly twice as long as the age of the Material Plane itself.

<small>— Lex, Arc IV Part II. The Company reached the same conclusion, named the hypothetical fifth phase **Perfect Dark**, judged it impossible, and re-sequestered the device.</small>

<small>The crystal specification Lex gives here — buried beyond its half-life for nearly twice the age of the Material Plane — describes the Anachron's own later history: the machine spends that span sealed under a volcano. See The Chronicle, below.</small>
...
> When St. Cloud brought the Anachron to use, we though he was a fool. Even though he knew of its nature, he didn't seem to grasp the true power of being able to move back and forth in Time. That's what that device promises. But now I know why he gave it to us. He wanted us to activate it, because he didn't know how. Like fools, we've been working on that problem for years. We tried using the infanta to turn it on, it hasn't worked. We had no intention of helping him, but a device like that is impossible not to study.

> You have to stop them from activating the Anachron. They can useiti to break time and open a wound in the world so great that nothing will survive.

<small>— Celion, Arc III Parts IX–XI, "Arcaneum." Sic on "we though" and "useiti." Celion had already been killed by the party ("You had blown me up") and was speaking from the clone Valen had moved into his own sanctum.</small>

Archmage **Valen** wanted it for the same reason St. Cloud did, and said so: "This magnificent device baffles me. We've tried everything to try and turn it on. We're certain this device will bring us to where and when we have to be to summon her, to summon the Leviathan." On St. Cloud he was dismissive — "a man, crude and comically short sighted. He was wise enough to bring the Anachron to me, so that I may assume his quest and rightly witness the final moments at her side." Neither St. Cloud nor the Arcaneum ever turned it on. The Company's own note is that the device springs to life when an elemental enters it willingly; the Arcaneum's attempts used an Infanta. <small>(Arc III Parts IX-XI.)</small>

## The Lexicon, before

The Lexicon was built by **Brightmantle** — the dwarven Infanta, the second Infanta, the lover of [Elistrae](/people/elistrae/) and, in the Company's phrase, "the dwarven king who built Motherstone" — to run the heart of the city, using the Obliviator and the great crystals in the mountain. It was infused with his personality and intelligence. Company Special Projects reached the same conclusion from the other direction: "The Company believes Magnus' patron god Brightmantle could have been the dwarven king who built Motherstone. Review of cursed historical record confirms this."
...
## Lex aboard the Arielle

After the transfer Lex travelled with the party. He ran the Arielle's core, reported his own findings on the drive, and worked on the machine with the crew: "Pim and Magnus are working with Lex on the Anachron" when Nub Clitman interrupted them. <small>(Aboard the ship; the session file heads the scene "AT THE SHIP.")</small> He was diminished, and said so, recalling what he had been "when he was in his fullest form." He later helped plan the assault on Netheril.
...
Two capabilities are recorded for the Anachron in that configuration, and both are about navigation rather than propulsion:

- "Lex will pick up coordinates for the 1st Infanta War from through the end of time."
...
At Starfall, St. Cloud "tinkers with the infernal machine with the Anachron," and when he judged the fight lost he "rushes the Anachron before his death and scrambles the core," then fled into a time portal. Each hero was given a split-second private choice to follow him or stay. Those who stayed were told the Anachron was gone with him; those who followed "tangle with him in the liminal space between this Time and the Next," where "he seems horrified and panicked that you have breached the anachronistic space, like maybe this hasn't happened before."

The party was left "scattered in Time." Because the party was strewn across every era, and because inside [the Egg](/places/the-egg/) all Times converge, they could arrive at the last battle from every era at once and, in June's instruction, "bring every force the can from whenever they are." <small>(Sic on "the can"; Arc V Part VI.)</small>

The Arielle came down in the deep, deep past — and the Anachron stayed there, with Lex inside it.

<small>The session plan for Arc V Part VI says of the characters who stayed in the past: "The Anachron is gone, as is St. Cloud." The later ship carries "no anachron, a standard arcane core which requires a new Power Stone" (Arc VII, Leviathan I).</small>
...
What Netheril did afterwards is the same act the machine had been built to perform. Zebulon can produce no evidence that his master Curtis Washington, his nation, or his own history ever existed: "besides these paltry notes and a few specks of memory that haunt me in my sleep, I have no record or evidence that Curtis Washington ever existed… There are ruins at Yog, Jhamdaath, Enkidu, but no one alive remembers how they were built or by whom. I have spent a lifetime trying to convince every Orc I see that they themselves and their ancestors built those ruins, and were betrayed. But to no avail." <small>(Arc VI Part IX, "The Chronicle." Zebulon's notes describe one of the erased devices as a great orb producing an "Obliviation" field — the Obliviator, described from the outside by someone who never learned its name.)</small>

## What the party went to it for

They did not go looking for Lex. They went because Zebulon told them the Chronicle was the only thing that could read a vision he had been given, and that the vision contained what they needed to enter **the Eye**:

> The Chronicle will know how to interpret my vision and give you the knowledge you need to enter the Eye.

The vision itself, in Zebulon's words: "I saw you, and a band of immortal heroes, step through the Deepgate at Motherstone and bow to the Queen of the Moon. At the same time, I watched the moon explode and form its rings, I saw the sinking of a ship, and I five blades piercing an opened eye. The eye had five pupils and an swirling iris made of eldritch runes, like the ones in my master's notes." <small>(Sic on "and I five blades." Arc VI Part IX.)</small>

The party in the vision is the party receiving it. Zebulon's account of why he trusts it is that it already came true: "Many years ago I traveled here to Motherstone to tell them of my vision. They were kind to me and told me that if my vision was to come to be, they would welcome Istus into the pantheon of benevolent gods. And now I see that my vision was true, because of course it was."

## The Chronicle

By the time the party reaches it, the machine sits under hardened magma northeast of Enkidu, "powered by the heat of an ancient volcano below the ground, but at one time, this was a towering and glittering ivory fortess. The Netherese destroyed it trying to get to the Chronicle. It must have erupted this magma to seal itself off and kill the attackers." Zebulon: "The Chronicle was the mythical living archive of my people. It is located near a volcanic vent from which it draws its power. Northeast of Enkidu, hidden there. Only the blessed of Cypher can access it, but it has been corrupted by those who have tried thus far."
...
The Obliviator was installed to trim the Lexicon's mind; the last use of Oblivia in the chronicle trims the Lexicon's mind again, and the Anachron's power with it. See [the Oblivia](/lore/the-oblivia/).
...
| The Starfall era | The Lexicon | The Sovereignty of Realms | Itself |

## Status

Extant. Core scrambled by St. Cloud at Starfall; the vessel left in the deep past at the crash of the Arielle and still there, sealed under its own magma, corrupted by everyone who has tried to reach it, and awake.

**Related:** [The Lexicon](/items/the-lexicon/) · [The Chronicle](/items/the-chronicle/) · [The Obliviator](/items/the-obliviator/) · [Motherstone](/places/motherstone/) · [Moonstone](/lore/moonstone/) · [The Mammon Machine](/items/the-mammon-machine/) · [The Oblivia](/lore/the-oblivia/)
