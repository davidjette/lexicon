---
title: Temple Holdings LLC
description: 'The founding chronicle of the Infantaverse in eight arcs: a band of strangers guard a reborn goddess from a shipwreck to the heart of a waking god.'
type: article
kind: lore
tags:
- Temple Holdings LLC
...
1. [**Hope in Exile**](/history/arc-i-hope-in-exile/) — shipwreck on the Moonshae, the infant goddess, and the long road home.
2. [**Motherstone**](/history/arc-ii-motherstone/) — the buried crystal city, the Lexicon and the Obliviator, and the betrayal that erased a kingdom.
3. [**Age of the Infanta**](/history/arc-iii-age-of-the-infanta/) — a goddess enthroned, a moonstone empire, and the race to seize the god-children awakening across Faerûn.
...
<small>— [Mara Mageblood's](/people/mara-mageblood/) Journal</small>

What the campaign uncovers follows from that missing piece: a machine that deletes information from every mind that ever held it, a mage who buried a kingdom's memory to hide from a blind god, a Company that reverse-engineered the machine into consumer goods, and — at the end of time — the revelation that Time itself is the same device on a cosmic scale, invented by a fragmented god-child to hide its consciousness from a father who devours by remembering.
