...
Lex, after experimenting with the drive aboard the Arielle, gave the requirement in the crystal's own terms:

> Perfect moon crystals must be kept out of moon light in order to maintain their ability to record and process magical thought energy. Only those which have been buried for millennia can perform this function, because they have moved beyond their half-life and are nearly empty of lunar energy, perfect vessels. The moonstone required for a calculation as complex as time travel would have to be buried for nearly twice as long as the age of the Material Plane itself.

<small>— Lex, Arc IV, [The Infernal Machines](/history/arc-iv-the-infernal-machines/), Part II. The Anachron contains "a very complex moonstone crystal" and, after the Second Battle of Motherstone, the Lexicon; it is then left in the deep past at the crash of the Arielle and spends millennia sealed under a volcano, where it is known as [the Chronicle](/items/the-chronicle/). The stone Lex specifies here is what that crystal becomes. (See [The Anachron](/items/the-anachron/).)</small>

## What a jump costs

Lex's findings after experiments with the transplanar drive, as recorded:

- "Jumps within the current plane expends 1 Power Stone per jump."
- "Jumping from the gate ring provides this energy for free, drawing it from the city's reserves."
- "Jumps to other planes expends 1 Perfect Stone and 1 Power Stone per jump." The Anachron "writes volumous and important data to the perfect stone before executing the jump. This renders the stone only good for jumping between these two points in each plane," and the crystal "can be used again but only by jumping from the original origin point to the original destination (not the reverse)."
...
Legend has it that in the time before history began, dwarven miners unearthed "a ten-faceted black gemstone of dark beauty" and presented it to Nimue, queen of the fey. The gem, "whispered to have been cut from the very center of the most perfect shard of the Moon ever found," slowly corrupted the fey princess **Maab**, "eating away her physical body and destroying her soul"; she left the Seelie Court with it and became the Queen of Air and Darkness.
